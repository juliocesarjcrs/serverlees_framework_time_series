...
class ModelTraining:
    ...
    def fit_model(self, model: BaseEstimator, train_x, train_y) -> BaseEstimator:
        """
    ...
    def predict_model(self, model: BaseEstimator, test_x):
        """
