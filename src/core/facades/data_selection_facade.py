...
class DataSelectionFacade:
    ...
    #         elif model_type == ModelsType.RANDOM_FOREST_REGRESSOR:
    #             self.model_training.set_model_Random_forest_regressor()
    #             self.logger.info(f'::: SET MODEL::: {ModelsType.RANDOM_FOREST_REGRESSOR.value}')
